...
export default function InternaDesenvolvedores(props) {

    const developers = props.match.params.id;
    const devName = props.match.params.name;
    ...
    useEffect(() => {
        setIsLoading(true);
        api.get(`games?developers=${developers}&page=${page}`).then(response => {
